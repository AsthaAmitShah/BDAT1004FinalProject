...
class ExchangeRateRow(db.Model):
    ...
    USD = db.Column(db.Float64)
    CAD = db.Column(db.Float64)
    INR = db.Column(db.Float64)
    EUR = db.Column(db.Float64)
    AED = db.Column(db.Float64)
    BHD = db.Column(db.Float64)
    HKD = db.Column(db.Float64)
    JPY = db.Column(db.Float64)
    Highest = db.Column(db.String(5))
    HighestValue = db.Column(db.Float64)
    Lowest = db.Column(db.String(5))
    LowestValue = db.Column(db.Float64)
